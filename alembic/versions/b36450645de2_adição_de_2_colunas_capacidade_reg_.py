"""Adição de 2 colunas: capacidade_reg_manha e capacidade_reg_tarde, as duas são Integer

Revision ID: b36450645de2
Revises: 
Create Date: 2025-03-07 16:06:16.708483
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('tb_uni_salas', sa.Column('capacidade_reg_manha', sa.Integer(), nullable=True))
    op.add_column('tb_uni_salas', sa.Column('capacidade_reg_tarde', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('tb_uni_salas', 'capacidade_reg_tarde')
    op.drop_column('tb_uni_salas', 'capacidade_reg_manha')
    ...
    sa.Column('rap_id', mysql.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('rap_id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
